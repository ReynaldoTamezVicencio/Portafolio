...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("CLINICA_TAMEZ_VICENCIODataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class CLINICA_TAMEZ_VICENCIODataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As CLINICA_TAMEZ_VICENCIODataSet = CType(MyBase.Clone,CLINICA_TAMEZ_VICENCIODataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "CLINICA_TAMEZ_VICENCIODataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/CLINICA_TAMEZ_VICENCIODataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As CLINICA_TAMEZ_VICENCIODataSet = New CLINICA_TAMEZ_VICENCIODataSet()
    ...
    Partial Public Class MedicosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddMedicosRow(ByVal ID_Medico As Integer, ByVal Nombre As String, ByVal Direccion As String, ByVal Telefono As String, ByVal Cedula As String) As MedicosRow
            Dim rowMedicosRow As MedicosRow = CType(Me.NewRow,MedicosRow)
            Dim columnValuesArray() As Object = New Object() {ID_Medico, Nombre, Direccion, Telefono, Cedula}
...
Namespace CLINICA_TAMEZ_VICENCIODataSetTableAdapters
    ...
    Partial Public Class MedicosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Medicos] WHERE (([ID_Medico] = @Original_ID_Medico) AND ([Nomb"& _ 
                "re] = @Original_Nombre) AND ([Direccion] = @Original_Direccion) AND ([Telefono] "& _ 
                "= @Original_Telefono) AND ([Cedula] = @Original_Cedula))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Medicos] ([ID_Medico], [Nombre], [Direccion], [Telefono], [Ced"& _ 
                "ula]) VALUES (@ID_Medico, @Nombre, @Direccion, @Telefono, @Cedula);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID_M"& _ 
                "edico, Nombre, Direccion, Telefono, Cedula FROM Medicos WHERE (ID_Medico = @ID_M"& _ 
                "edico)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Medicos] SET [ID_Medico] = @ID_Medico, [Nombre] = @Nombre, [Direcci"& _ 
                "on] = @Direccion, [Telefono] = @Telefono, [Cedula] = @Cedula WHERE (([ID_Medico]"& _ 
                " = @Original_ID_Medico) AND ([Nombre] = @Original_Nombre) AND ([Direccion] = @Or"& _ 
                "iginal_Direccion) AND ([Telefono] = @Original_Telefono) AND ([Cedula] = @Origina"& _ 
                "l_Cedula));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID_Medico, Nombre, Direccion, Telefono, Cedula FROM Medicos "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.ConexionClinica.My.MySettings.Default.CLINICA_TAMEZ_VICENCIOConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID_Medico, Nombre, Direccion, Telefono, Cedula FROM dbo.Medicos"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        ID_Medico, Nombre, Direccion, Telefono, Cedula"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Med"& _ 
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As CLINICA_TAMEZ_VICENCIODataSet.MedicosDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As CLINICA_TAMEZ_VICENCIODataSet.MedicosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As CLINICA_TAMEZ_VICENCIODataSet.MedicosDataTable = New CLINICA_TAMEZ_VICENCIODataSet.MedicosDataTable()
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As CLINICA_TAMEZ_VICENCIODataSet.MedicosDataTable, ByVal valor As String) As Integer
        ...
        Public Overloads Overridable Function GetDataByNombreMedicos(ByVal valor As String) As CLINICA_TAMEZ_VICENCIODataSet.MedicosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (valor Is Nothing) Then
                Throw New Global.System.ArgumentNullException("valor")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As CLINICA_TAMEZ_VICENCIODataSet.MedicosDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As CLINICA_TAMEZ_VICENCIODataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID_Medico As Integer, ByVal Original_Nombre As String, ByVal Original_Direccion As String, ByVal Original_Telefono As String, ByVal Original_Cedula As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal ID_Medico As Integer, ByVal Nombre As String, ByVal Direccion As String, ByVal Telefono As String, ByVal Cedula As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ID_Medico As Integer, ByVal Nombre As String, ByVal Direccion As String, ByVal Telefono As String, ByVal Cedula As String, ByVal Original_ID_Medico As Integer, ByVal Original_Nombre As String, ByVal Original_Direccion As String, ByVal Original_Telefono As String, ByVal Original_Cedula As String) As Integer
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_ID_Medico,Integer)
            If (Original_Nombre Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Nombre")
            Else
        ...
        Public Overloads Overridable Function Update(ByVal Nombre As String, ByVal Direccion As String, ByVal Telefono As String, ByVal Cedula As String, ByVal Original_ID_Medico As Integer, ByVal Original_Nombre As String, ByVal Original_Direccion As String, ByVal Original_Telefono As String, ByVal Original_Cedula As String) As Integer
            Return Me.Update(Original_ID_Medico, Nombre, Direccion, Telefono, Cedula, Original_ID_Medico, Original_Nombre, Original_Direccion, Original_Telefono, Original_Cedula)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As CLINICA_TAMEZ_VICENCIODataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As CLINICA_TAMEZ_VICENCIODataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._medicosTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As CLINICA_TAMEZ_VICENCIODataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._medicosTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As CLINICA_TAMEZ_VICENCIODataSet) As Integer
